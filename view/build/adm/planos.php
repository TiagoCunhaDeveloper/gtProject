...
<head lang="pt-br">
	...
	<title>Catálogo Tempário - Planos</title>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Cadastrar novo plano</h5>
      ...
      <div class="modal-body">
        <fieldset class="form-group">
						...
						<fieldset class="form-group">
							<label class="form-label semibold" for="exampleInput">Quantidade créditos*</label>
							<input type="text" class="form-control" id="exampleInput" >
						...
						<fieldset class="form-group">
							<label class="form-label semibold" for="exampleInput">Botão pag seguro*(Código)*</label>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>
				...
				<header class="card-header card-header-xl">
					Planos cadastrados <button type="button" class="btn btn-inline" style="float:right" data-toggle="modal" data-target="#myModal1"><i class="fa fa-plus"></i> Cadastrar  novo plano</button>
				</header>
